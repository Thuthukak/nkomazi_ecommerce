...
<header>
        ...
        <div class="container">
            <div class="row clearfix align-items-center">
                <div class="col-lg-3 col-md-9 col-sm-6">
                    <div class="brand-logo text-lg-center">
                        ...
                        <a href="{{ url('/') }}">
                            ...
                            <img src="{{ asset('front/images/main-logo/main-logo.png') }}" alt="Nkomazi" class="app-brand-logo">
                        </a>
                    </div>
                </div>
                <div class="col-lg-6 u-d-none-lg">
                    ...
                    <form class="form-searchbox " action="{{ url('/search-products') }}" method="get" style="border: 1px solid #ddd; border-radius: 10px;">
    ...
    <!-- Bottom-Header -->
    <div class="full-layer-bottom-header mt-5 ml-3">
        <div class="container">
        ...
        <nav>
            <div class="v-wrapper">
                <ul class="v-list animated fadeIn">
                    ...
                    <!-- Vendor list item similar to categories -->
                ...
                <div class="col-lg-9 border-1 border-rounded-lg">
